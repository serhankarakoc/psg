...
func InitDB() {
	...
	dbConfig := DatabaseConfig{
		...
		Name:     envconfig.String("DB_DATABASE", "myapp"),
...
// küçük yardımcı (strconv.Itoa yerine import taşımamak için)
func itoa(i int) string {
	// hızlı ve basit
	return fmtInt(i)
}

// minimal alloc ile int -> string
func fmtInt(i int) string {
	// not: istersen burayı strconv.Itoa'ya çevirebilirsin;
	// ben dependency sadeleşsin diye ufak bir helper bıraktım.
	// production'da strconv.Itoa kullanmak gayet yeterli.
